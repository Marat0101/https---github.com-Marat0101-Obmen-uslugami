...
class UpdateProductDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { description: { required: true, type: () => String }, cost: { required: true, type: () => String }, title: { required: true, type: () => String }, places: { required: true, type: () => String }, categoryId: { required: true, type: () => Number }, duration: { required: true, type: () => String }, format: { required: true, type: () => String } };
    }
}
...
__decorate([
    ...
    __metadata("design:type", String)
], UpdateProductDto.prototype, "format", void 0);
